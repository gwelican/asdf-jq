...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for jq.
GH_REPO="https://github.com/jqlang/jq"
TOOL_NAME="jq"
TOOL_TEST="jq --version"
...
# NOTE: You might want to remove this if jq is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if jq has other means of determining installable versions.
	list_github_tags
}
